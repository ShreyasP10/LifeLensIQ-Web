...
const SITES = [
  ...
  ['github.com', '/life-lens-iq', 'LifeLensIQ — code', 'Development', 'tab_active', 5, 1200, 3600],
  ['chat.openai.com', '/', 'GPT: explaining gradient descent', 'Development', 'tab_active', 5, 600, 1800],
  ...
  ['instagram.com', '/', 'Feed — scrolling', 'Social', 'tab_active', 5, 300, 1200],
  ['web.whatsapp.com', '/', 'Chats — replying', 'Social', 'tab_active', 4, 300, 900],
  ['x.com', '/home', 'Timeline — scrolling', 'Social', 'tab_active', 3, 300, 900],
